...
const logoSrc = 'https://vpiinnovativesolutions.com/wp-content/uploads/2025/06/vpi_logo_transparent_highres.png';
    ...
    <footer className="site-footer site-footer-vpi page-pad" data-theme="black" data-testid="site-footer">
      <div className="footer-brand-strip">
        <Link to="/" className="footer-brand" aria-label="VPI Innovative Solutions home">
          <img src={logoSrc} alt="VPI Innovative Solutions" className="footer-logo-image" />
          <span>VPI Innovative Solutions</span>
        </Link>
        <div className="footer-brand-copy">
          <span className="footer-kicker">PRECISION ENGINEERING</span>
          <p>Leaders in CNC Component Manufacturing.</p>
        </div>
      </div>
      ...
      <div className="footer-main-grid">
        ...
        <div className="footer-map-card">
          <div className="footer-map-head">
            <span className="footer-kicker">LOCATION</span>
            <a href="https://www.google.com/maps/search/?api=1&query=Ksetra+Tech+Park+Koorgalli+Industrial+Area+Mysore+570018" target="_blank" rel="noreferrer">OPEN MAP <ArrowUpRight size={13} /></a>
          </div>
